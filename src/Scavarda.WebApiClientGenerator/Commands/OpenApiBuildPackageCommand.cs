...
{
    [Command(Description = "Build package for WebApi Client from swagger.json file")]
    class OpenApiBuildPackageCommand : CommandBase
    {
        ...
        [Option("-o|--output <output_folder>", "WebApi client package output folder", CommandOptionType.SingleValue)]
        [LegalFilePath]
        ...
        protected override int OnExecute(CommandLineApplication app)
        {
            ...
            _swaggerCodeGeneratorService.BuildPackage(InputFile, OutputFolder, language, PackageName, PackageVersion);
